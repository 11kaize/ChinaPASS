...
- 首页「任务入口」+ 9 个场景的分步 SOP，**按一次真实落地的时间线排列**（入境通关 → SIM → 支付 → 打车 → 酒店 → 地铁 → 高铁 → 外卖 → 紧急）
- 96 张双语急救卡片，支持全屏大字展示、中英对照、一键复制
- 每页含 Plan B、常见错误、故障排查、更新时间与官方来源
- **EN / 中文 / 日本語 / 한국어** 四语种切换 —— 卡片上的中文是递给中国人看的正文，永不翻译
- 自动定位城市（离线匹配，坐标不出设备）+ 「我的位置」卡片
- 4 屏首启引导，含 AI 问答入口占位
