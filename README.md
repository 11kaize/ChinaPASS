...
当前阶段的形态是**只做卡片**：外国人在中国遇到说不通的情况，打开卡片，全屏中文大字，把手机递给对方看。

- 9 组 · 59 张卡片，按紧急程度排序，含一组万能卡「说不通时」
- 一点直达求助卡，110 / 120 一点拨号
- 递给对方时按钮自动隐藏，整屏只有中文
- 纯静态、无依赖、无后端，双击 `demo/index.html` 也可以本地运行

> **卡片是单向的**，只解决「我怎么说出去」，不处理对方用中文回话。这是当前版本有意划定的边界，原因见 [demo/README.md](demo/README.md)。
